...
def fill_pdf_form_with_data(pdf_file_name):
    ...
    newpath = r'C:\Users\think\OneDrive\Desktop\spark_capital\document' 
    ...
    print(file_version4)
    copy_final_file_version(file_version4)
    try:
...
def main():
    pdf_file_name = 'Account Opening Form ARN- BSE STAR MF V 2.0.pdf'
    fill_pdf_form_with_data(pdf_file_name)
